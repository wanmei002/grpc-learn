...
var file_proto_product_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x65, 0x73, 0x63, 0x22, 0x2b, 0x0a, 0x03, 0x52, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04,
	...
	0x73, 0x67, 0x32, 0x37, 0x0a, 0x0b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x12, 0x28, 0x0a, 0x08, 0x41, 0x64, 0x64, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x0e, 0x2e,
	0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x1a, 0x0c, 0x2e,
	0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x52, 0x65, 0x73, 0x42, 0x18, 0x5a, 0x16, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x3b, 0x70, 0x72,
...
var file_proto_product_proto_goTypes = []interface{}{
	...
	(*Res)(nil),   // 1: product.Res
}
var file_proto_product_proto_depIdxs = []int32{
	0, // 0: product.OrderServer.AddOrder:input_type -> product.Order
	1, // 1: product.OrderServer.AddOrder:output_type -> product.Res
...
type OrderServerClient interface {
	AddOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Res, error)
}
...
func (c *orderServerClient) AddOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, "/product.OrderServer/AddOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServerServer interface {
	AddOrder(context.Context, *Order) (*Res, error)
}
...
func (*UnimplementedOrderServerServer) AddOrder(context.Context, *Order) (*Res, error) {
...
func _OrderServer_AddOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Order)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServerServer).AddOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.OrderServer/AddOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServerServer).AddOrder(ctx, req.(*Order))
	}
	return interceptor(ctx, in, info, handler)
}

var _OrderServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "product.OrderServer",
	HandlerType: (*OrderServerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AddOrder",
			Handler:    _OrderServer_AddOrder_Handler,
		},
	},
